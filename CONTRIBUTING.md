...
Thank you for your interest in `strong-build`, an open source project
administered by StrongLoop.

Contributing to `strong-build` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/strong-build)
